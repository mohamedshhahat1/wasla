...
from app.integrations.google.client import GoogleExchangeFailed, GoogleOAuthClient
...
class GoogleAuthService:
    ...
    async def _start(self, *, kind: FlowKind, user: User | None) -> tuple[str, int]:
        ...
        # log line instead - see the audit vocabulary note in ADR-044.
        logger.info(
    ...
    async def _enrol(
        ...
        *,
        ...
        signature we checked (ADR-046). It grants nothing - `users.py` records
        ...
        honest consequence is disclosed in ADR-043 - such an account holds a
    ...
    async def unlink(self, *, user: User) -> None:
        ...
        reaches it. Documented in ADR-045.
        """
    ...
    async def _redeem(
        ...
        *,
        ...
        except GoogleExchangeFailed as exc:
